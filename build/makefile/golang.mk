...
GO_ENV_ARCH_AMD=-e GOOS=linux -e GOARCH=amd64
GO_ENV_ARCH_ARM=-e GOOS=linux -e GOARCH=arm64
DOCKER_GO_COMMAND=${DOCKER_GO_BASE_COMMAND} golang:${GO_IMAGE_VERSION}
DOCKER_GO_COMMAND_AMD=${DOCKER_GO_BASE_COMMAND} ${GO_ENV_ARCH_AMD} golang:${GO_IMAGE_VERSION}
DOCKER_GO_COMMAND_ARM=${DOCKER_GO_BASE_COMMAND} ${GO_ENV_ARCH_ARM} golang:${GO_IMAGE_VERSION}
...
build-go: build-go-amd build-go-arm
